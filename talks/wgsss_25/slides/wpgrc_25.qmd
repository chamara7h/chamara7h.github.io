...
synthetic_tsibble <- read_rds(here::here('data/tidy_data/synthetic_data.rds'))
...
stock_tsb <- read_rds(here::here('data/tidy_data/stock_tsb_filtered.rds')) |> 
  as_tibble() |> 
...
rel_iva <- read_rds(here::here('data/results/emp_rel_iva.rds'))

num_ex_metrics_all <- read_rds(here::here('data/results/emp_ex_metrics_origin_all.rds'))
