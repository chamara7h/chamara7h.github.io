...
stock_tsb <- read_rds('data/tidy_data/stock_tsb_filtered.rds') |> 
  as_tibble() |> 
...
rel_iva <- read_rds('data/results/emp_rel_iva.rds')

num_ex_metrics_all <- read_rds('data/results/emp_ex_metrics_origin_all.rds')
