...
format: 
  revealjs:
    ...
    footer: "[Introduction to Markov Processes in Healthcare Supply Chains](https://chamara7h.github.io/talks/)"
    css: theme.css
    theme: simple
    echo: true
...
If the weather is not a good example of a Markov chain, then what is?
