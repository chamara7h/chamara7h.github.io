...
<span style="color:red;">✗ May struggle to capture sudden shifts or non-standard patterns if the smoothing parameters are constant</span>  
...
*Female condom needs for August 2020 (example)*

| Parameter                                      | Value    | Unit         | Sources          |
|-----------------------------------------------|---------|-------------|-----------------|
| **A. Women population 20 – 25**               | 345,000 | # of people | WorldPop        |
| **B. Percentage of women who will use a contraceptive product (mCPR)** | 68%  | %            | PMA DataLab     |
| **C. Percentage of the method mix**           | 26%     | %            | PMA DataLab     |
| **D. CYP**                                    | 120     | -           | USAID           |
| **E. Percentage of brand A mix**              | 45%     | %            | Author calculation |
| **F. Percentage of source mix**               | 13%     | %            | USAID           |
| **G. Weight as a percentage for August**      | 8%      | %            | Author calculation |
| **Total requirement (A × B × C × D × E × F × G)** | **34,255** | # of products | - |
